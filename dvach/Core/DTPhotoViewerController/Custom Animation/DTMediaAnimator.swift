...
///
public protocol DTMediaViewerBaseAnimator: UIViewControllerAnimatedTransitioning {
...
public class DTMediaAnimator: NSObject, DTMediaViewerBaseAnimator {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if isPresenting {
            guard let photoViewerController = toViewController as? DTMediaViewerController else {
            ...
            guard let photoViewerController = fromViewController as? DTMediaViewerController else {
                fatalError("view controller does not conform DTPhotoViewer")
            }
