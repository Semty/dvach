...
@objc public protocol DTMediaViewerControllerDataSource {
    ...
    @objc optional func mediaViewerController(_ mediaViewerController: DTMediaViewerController, configureCell cell: DTWebMCollectionViewCell, forVideoAt index: Int)
